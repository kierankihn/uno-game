...
TEST(MessageSerializerTest, SerializeJoinGameMessage)
{
    ...
    Message message(MessagePayloadType::JOIN_GAME, payload);
...
TEST(MessageSerializerTest, SerializeStartGameMessage)
{
    ...
    Message message(MessagePayloadType::START_GAME, payload);
...
{
    DrawCardPayload payload{5};
    Message message(MessagePayloadType::DRAW_CARD, payload);
...
TEST(MessageSerializerTest, SerializePlayCardMessage)
{
    ...
    Message message(MessagePayloadType::PLAY_CARD, payload);
...
TEST(MessageSerializerTest, SerializeInitGameMessage)
{
    ...
    Message message(MessagePayloadType::INIT_GAME, payload);
...
TEST(MessageSerializerTest, SerializeEndGameMessage)
{
    ...
    Message message(MessagePayloadType::END_GAME, payload);
...
{
    std::string json = R"({"payload_type":"JOIN_GAME","payload":{"name":"Player1"}})";
...
{
    std::string json = R"({"payload_type":"JOIN_GAME","payload":{"name":""}})";
...
{
    std::string json = R"({"payload_type":"DRAW_CARD","payload":{"draw_count":5}})";
...
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":{"card_color":"Red","card_type":"5"}}})";
...
{
    std::string json = R"({"payload_type":"END_GAME","payload":null})";
...
{
    JoinGamePayload payload{"Player1"};
    Message original(MessagePayloadType::JOIN_GAME, payload);
...
TEST(MessageSerializerTest, RoundTripAllMessageTypes)
{
    ...
    messages.emplace_back(MessagePayloadType::JOIN_GAME, JoinGamePayload{"TestPlayer"});
    messages.emplace_back(MessagePayloadType::START_GAME, StartGamePayload{});
    messages.emplace_back(MessagePayloadType::DRAW_CARD, DrawCardPayload{3});
    messages.emplace_back(MessagePayloadType::PLAY_CARD, PlayCardPayload{Card(CardColor::RED, CardType::NUM5)});
    messages.emplace_back(MessagePayloadType::END_GAME, EndGamePayload{});
...
{
    std::string json = R"({"payload_type":"JOIN_GAME","payload":null})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeJoinGameWithArrayPayload)
{
    std::string json = R"({"payload_type":"JOIN_GAME","payload":[]})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeJoinGameWithNumberPayload)
{
    std::string json = R"({"payload_type":"JOIN_GAME","payload":123})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"JOIN_GAME","payload":{"name":123}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeJoinGameWithNullName)
{
    std::string json = R"({"payload_type":"JOIN_GAME","payload":{"name":null}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"START_GAME","payload":{}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"START_GAME","payload":"test"})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"DRAW_CARD","payload":null})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeDrawCardWithArrayPayload)
{
    std::string json = R"({"payload_type":"DRAW_CARD","payload":[]})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"DRAW_CARD","payload":{"draw_count":null}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"DRAW_CARD","payload":{"draw_count":5.5}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":null})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializePlayCardWithArrayPayload)
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":[]})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":null}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializePlayCardWithArrayCard)
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":[]}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializePlayCardWithStringCard)
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":"Red 5"}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializePlayCardWithMissingCardColor)
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":{"card_type":"5"}}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializePlayCardWithMissingCardType)
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":{"card_color":"Red"}}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializePlayCardWithInvalidCardColor)
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":{"card_color":"Purple","card_type":"5"}}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializePlayCardWithInvalidCardType)
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":{"card_color":"Red","card_type":"Invalid"}}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializePlayCardWithNumberCardColor)
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":{"card_color":123,"card_type":"5"}}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":{"card_color":null,"card_type":"5"}}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializePlayCardWithNullCardType)
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":{"card_color":"Red","card_type":null}}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializePlayCardWithEmptyCardColor)
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":{"card_color":"","card_type":"5"}}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializePlayCardWithEmptyCardType)
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":{"card_color":"Red","card_type":""}}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"PLAY_CARD","payload":{"card":{"card_color":"Red","card_type":"skip"}}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":null})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithArrayPayload)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":[]})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithMissingDiscardPile)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"hand_card":[],"current_player":0}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithMissingHandCard)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"discard_pile":[],"current_player":0}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithMissingCurrentPlayer)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"discard_pile":[],"hand_card":[]}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithNullDiscardPile)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"discard_pile":null,"hand_card":[],"current_player":0}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithNullHandCard)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"discard_pile":[],"hand_card":null,"current_player":0}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithStringDiscardPile)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"discard_pile":"test","hand_card":[],"current_player":0}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithStringHandCard)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"discard_pile":[],"hand_card":"test","current_player":0}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithStringCurrentPlayer)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"discard_pile":[],"hand_card":[],"current_player":"0"}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithNullCurrentPlayer)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"discard_pile":[],"hand_card":[],"current_player":null}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithNegativeCurrentPlayer)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"discard_pile":[],"hand_card":[],"current_player":-1}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithFloatCurrentPlayer)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"discard_pile":[],"hand_card":[],"current_player":1.5}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json =
        R"({"payload_type":"INIT_GAME","payload":{"discard_pile":[{"card_color":"Invalid","card_type":"5"}],"hand_card":[],"current_player":0}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json =
        R"({"payload_type":"INIT_GAME","payload":{"discard_pile":[],"hand_card":[{"card_color":"Red","card_type":"Invalid"}],"current_player":0}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithNonObjectCardInDiscardPile)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"discard_pile":["string"],"hand_card":[],"current_player":0}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}

TEST(MessageSerializerTest, DeserializeInitGameWithNonObjectCardInHandCard)
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"discard_pile":[],"hand_card":[123],"current_player":0}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"END_GAME","payload":{}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"END_GAME","payload":"test"})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"START_GAME","payload":null,"extra_field":"ignored"})";
    Message message  = MessageSerializer::deserialize(json);
    EXPECT_EQ(message.getMessagePayloadType(), MessagePayloadType::START_GAME);
}
...
{
    std::string json = R"({"payload_type":"JOIN_GAME","payload":{"name":"Player1","extra":"ignored"}})";
    Message message  = MessageSerializer::deserialize(json);
    auto payload     = std::get<JoinGamePayload>(message.getMessagePayload());
    EXPECT_EQ(payload.playerName, "Player1");
}
...
TEST(MessageSerializerTest, DeserializeVeryLongPlayerName)
{
    ...
    nlohmann::json json = {{"payload_type", "JOIN_GAME"}, {"payload", {{"name", longName}}}};
...
{
    std::string json = R"({"payload_type":"DRAW_CARD","payload":{"draw_count":2147483647}})";
    Message message  = MessageSerializer::deserialize(json);
    auto payload     = std::get<DrawCardPayload>(message.getMessagePayload());
...
{
    std::string json = R"({"payload_type":"INIT_GAME","payload":{"discard_pile":[],"hand_card":[],"current_player":4294967295}})";
    Message message  = MessageSerializer::deserialize(json);
    auto payload     = std::get<InitGamePayload>(message.getMessagePayload());
...
{
    std::string json = R"({"payload_type":"JOIN_GAME","payload":{"name":"玩家123🎮"}})";
    Message message  = MessageSerializer::deserialize(json);
    auto payload     = std::get<JoinGamePayload>(message.getMessagePayload());
...
TEST(MessageSerializerTest, DeserializeAllCardColors)
{
    ...
    for (const auto &[colorStr, colorEnum] : colors) {
        nlohmann::json json = {{"payload_type", "PLAY_CARD"}, {"payload", {{"card", {{"card_color", colorStr}, {"card_type", "5"}}}}}};
        Message message     = MessageSerializer::deserialize(json.dump());
        auto payload        = std::get<PlayCardPayload>(message.getMessagePayload());
...
TEST(MessageSerializerTest, DeserializeAllCardTypes)
{
    ...
    for (const auto &[typeStr, typeEnum] : types) {
        nlohmann::json json = {{"payload_type", "PLAY_CARD"}, {"payload", {{"card", {{"card_color", "Red"}, {"card_type", typeStr}}}}}};
        Message message     = MessageSerializer::deserialize(json.dump());
        auto payload        = std::get<PlayCardPayload>(message.getMessagePayload());
...
TEST(MessageSerializerTest, DeserializeJSONBomb)
{
    ...
    std::string json = R"({"payload_type":"JOIN_GAME","payload":{"name":"player"}})";
    for (int i = 0; i < 100; ++i) {
...
{
    std::string json = R"({"payload_type":"JOIN_GAME","payload":{"name":"Player)" + std::string(1, '\0') + R"(1"}})";
    EXPECT_THROW(MessageSerializer::deserialize(json), std::invalid_argument);
}
...
{
    std::string json = R"({"payload_type":"JOIN_GAME","payload":{"name":"'; DROP TABLE users; --"}})";
    Message message  = MessageSerializer::deserialize(json);
    auto payload     = std::get<JoinGamePayload>(message.getMessagePayload());
...
{
    std::string json = R"({"payload_type":"JOIN_GAME","payload":{"name":"<script>alert('XSS')</script>"}})";
    Message message  = MessageSerializer::deserialize(json);
    auto payload     = std::get<JoinGamePayload>(message.getMessagePayload());
...
{
    std::string json = R"({"payload_type":"JOIN_GAME","payload":{"name":"../../etc/passwd"}})";
    Message message  = MessageSerializer::deserialize(json);
    auto payload     = std::get<JoinGamePayload>(message.getMessagePayload());
